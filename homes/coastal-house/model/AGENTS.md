...
- Retain twenty direct relative library links and pin versions in project.json. Changes to shared materials require a new library version.

- Save all ten named cameras including front arrival, roof/parking, west garden and entry hall. Verify actual instance geometry for closets and parked-car/pedestrian clearances after reopening.
