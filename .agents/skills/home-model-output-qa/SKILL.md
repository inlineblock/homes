...
2. Ask for a believable architectural photograph of **the same design and view**. Lock massing, roof slopes, floor count, openings, frame/post/beam positions, furniture layout, material palette, terrain and operating states. Improve light, reflections, material texture and photographic realism without adding architecture, furniture or landscaping. Name the view's important constraints, such as a wall-attached pergola with no house-side posts or matching exposed interior timber.
3. Inspect the generated image beside its source. Check geometry and material drift, invented doors/storeys/terraces, missing supports, changed furniture and lost signature details. Correct mismatches with focused Image Gen edits and review again before selection. If the architecture itself needs improvement, fix the model and rerender first; an attractive generated deviation is not an approved model change.
