...
Fourteen final native images, an exterior and three interior Imagegen studies, floor/site drawings, the measured roof section and all ten booklet pages have been visually reviewed and promoted. Native, export and output evidence are recorded separately.
...
Nine affected native views were rendered at 3200 x 2000: rear open/closed, great room, west garden, entry hall, living retreat, vaulted living, kitchen-to-vault and the dedicated fireplace view. Five existing reviewed views are retained because the revised west living wall is outside their visible content: serving counter open/closed, front arrival, roof/parking and primary bath. The pergola door and counter pairs retain their identical cameras and real panel movement. Floor plan and roof section were updated; all ten final booklet pages were rendered and visually reviewed. No independent specialist-agent review is claimed for this scoped correction.

The exterior hero and three interior studies use built-in Imagegen from current reviewed native sources, including a dedicated fireplace study. Fine textures, daylight, backdrop, foliage and small details remain photographic interpretations. Native views remain beside them, with actual prompts and source/image hashes in the gallery and provenance files.
...
Four registered Image Gen studies cover the terrace hero, vaulted living, kitchen-to-vault and the fireplace. This is a focused set, not the broader full-home photographic tour. Remaining candidates include front arrival, side/roof and parking, serving counter and primary bath.

## Solid west living wall and fireplace

The user clarified that the west-facing living-room windows should become a solid fireplace wall, and explicitly protected the doors below the pergola. The 12-foot window bay is removed. The new warm plaster room face continues to the actual sloping ceiling and rear-wall corner; the existing structural post remains within it. Mushroom exterior plaster matches the existing wall. The primary bathroom privacy window is retained.

The reused 48-inch electric concept now faces east from a six-foot limestone surround on that solid wall. Its former pocket-wall placement is removed. Actual native checks measure a 4.07 ft chaise-to-hearth gap and a clear 3 ft front-removal volume. The insert has a real recess, and 16,800 panel/fireplace checks across seven frames pass. Twenty interior circulation routes and the existing 420 panel/wall checks pass. Final product, thermal, ventilation and electrical installation remain unselected.

The [protected-door comparison](model/pergola-door-validation.json) checks the previous committed native model against the rebuilt file: 326 pergola, door, track, pocket, facade and drain objects have identical geometry, transforms and materials at frames 1, 20, 40, 60, 80, 100 and 120. The door under the pergola has not changed. Existing limestone pocket cladding and the vertical wall light are retained.

Validation uses Blender 4.5.14 LTS and Bonsai 0.8.5. The IFC import reopens 798 meshes and compares 136 actual products against IFC tessellation. Bonsai used its bundled pure-Python IFC wheels in a temporary process dependency directory; no preferences were saved. The updated native file, IFC, plans and gallery record the same reviewed revision.
