...
The latest direction is **a warm red-brick base, continuous charcoal stacked-window bay through its gable, subdued mushroom/taupe and charcoal upper volumes, better rectangular windows and clean details**. It supersedes the earlier farmhouse and bright-cream revisions, including their full-height light stripes. The premium profile guides proposed equipment and finishes; household occupancy and accessibility needs have not been supplied.
...
|---|---|---|
| Exterior | `warm-red-brick/v003` on 118 meshes with named physical-meter brick UVs; brick lower storey, complete charcoal front bay/gable, shared mushroom upper volumes, dark pitched roof and smoked-oak entry details | Wall assembly, attachment, flashing, drainage, roof intersections, structure and weather performance; listing solar remains unmodeled |
...
| Low front study roof | Unoccupied roof with slimmer aligned edge, thin dark coping, rearward fall and outlet. No terrace door, deck finish or guard | Occupied-roof conversion is not part of this revision; any such change requires deliberate upstairs access, coordinated plan, structure, guards, waterproofing and drainage |
