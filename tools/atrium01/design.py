...
WALLS = [
 ('south',(0,.25),(60,.25),.5,[(3,12,2.8,8.5,'window'),(31,5,0,8.5,'entry'),(45,13,6.8,8.7,'window')]),
 ('west',(.25,0),(.25,44),.5,[(3,7,2.8,8.5,'window'),(22,6,2.8,8.5,'window'),(33,9,.5,8.5,'window')]),
 ('north',(0,43.75),(60,43.75),.5,[(2,14,.5,8.5,'window'),(20,6,6,8.5,'window'),(29,29,.1,8.7,'glass')]),
 ('east',(59.75,0),(59.75,44),.5,[(11,31,.1,8.7,'glass')]),
 ...
 ('entry-bath-east',(30,0),(30,8),.35,[(3,3,0,7.5,'door')]),
...
CAMERAS = {
 ...
 '03 Atrium exterior': ((99,-63,30),(30,19,3),39),
 '04 Whole-home cutaway': ((87,-61,92),(30,22,0),45),
 '05 Rear terrace': ((101,92,24),(31,24,3),39),
 '06 West roof and atrium': ((-58,83,65),(30,22,1),42),
 '07 Open-air atrium': ((35.8,11.8,5.5),(25.6,21.5,4.3),22),
}
