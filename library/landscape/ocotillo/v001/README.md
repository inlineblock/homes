...
|---|---|---|---|
| leafless-canes | `ocotillo__leafless_canes` | 2.19 × 2.60 × 3.38 | Sparse leafless jointed canes with woody spines |
| rain-leafed | `ocotillo__rain_leafed` | 2.81 × 2.47 × 3.37 | Rain-responsive small oval foliage on canes |
| scarlet-tips | `ocotillo__scarlet_tips` | 2.43 × 2.41 × 4.23 | Dry canes with terminal scarlet tubular bloom clusters |
...
Actual whole plants and details reviewed. Airy palo verde foliage, fuller willow crown and tubular flowers, attached ocotillo thorn bases, and continuous cactus ribs with rounded areoles are visible. Procedural repetition and simplified close surfaces remain; captions slightly overlap some studio plinths.
