...
- Use the named `Warm red brick | running bond | meters` shader, not the individual clay-unit material. Apply `Brick meters` UVs after final transforms, including the angled garage wing.
