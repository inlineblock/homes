...
|---|---|---|---|
| small-tree | `RockyMountainMaple_small_tree` | 2.36 × 2.43 × 3.59 | Small branching understory tree |
| multi-stem | `RockyMountainMaple_multi_stem` | 2.60 × 2.59 × 2.60 | Broad multi-stem montane shrub |
| autumn | `RockyMountainMaple_autumn` | 2.44 × 2.43 × 2.96 | Yellow autumn shrub with staggered scaffold limbs |
