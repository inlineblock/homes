...
The raised coastal pavilion uses the following pinned shared asset families. The fresh native adoption audit confirms all 37 exact asset versions match the manifest and are actually used, directly or through declared linked parents.
...
| Oak wardrobe | `cabinetry/oak-wardrobe-2ft` | v001 | Thirteen guest/dressing/pantry/coat/linen bays |
...
The [adoption audit](../model/asset-adoption.json) verifies these 37 pins against the reopened model. Keep nested material links relative and published versions immutable. Plants permit restrained uniform scale/rotation; furniture, paving, storage and fixtures keep their published dimensions.
...
The current facade uses **five full linked panels and 31 separately labeled perimeter cuts**. Both types retain the same limestone material and nominal thickness. Driftwood, roof metal, wall-panel and vault-pendant assets are new reusable variations; the other 33 pins reuse existing versions.
