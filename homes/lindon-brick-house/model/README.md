...
`lindon-brick-house.blend` is the furnished visualization source. The IFC is classified concept geometry, including linked window meshes; it is not a complete BIM specification. Native and IFC validation receipts live beside the files.
...
blender --background homes/lindon-brick-house/model/lindon-brick-house.blend --python tools/lindon06/render.py -- --samples 192
