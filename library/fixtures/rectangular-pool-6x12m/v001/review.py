...
data=bpy.data.cameras.new('Preview');o=bpy.data.objects.new('Preview',data);s.collection.objects.link(o);o.location=pos;data.type='ORTHO';data.ortho_scale=extent*1.38;o.rotation_euler=(target-pos).to_track_quat('-Z','Y').to_euler();s.camera=o
