# Roller blackout 48in 107p4in | two states

[Manifest](asset.json) · [Native source](roller-blackout-48in-107p4in.blend) · [Validation](validation.json)
...
Nominal width denotes framed bay pitch: cassette width is pitch−12mm and fabric width is pitch−50mm. With the declared host visible glazing at pitch−84mm, fabric overlaps each jamb17mm; adjacent cassettes have12mm separation. These dimensions do not establish tested edge light sealing.
