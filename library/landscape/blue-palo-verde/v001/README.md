...
|---|---|---|---|
| young-open | `blue_palo_verde__young_open` | 4.05 × 4.15 × 3.85 | Young airy single-trunk leaf-on tree |
| mature-spreading | `blue_palo_verde__mature_spreading` | 6.21 × 5.51 × 5.93 | Mature multi-leader green bark canopy |
| yellow-bloom | `blue_palo_verde__yellow_bloom` | 5.60 × 5.83 × 5.69 | Mature yellow-flowering spreading crown |
